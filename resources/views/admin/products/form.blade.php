<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input name="name_en" value="{{ old('name_en',$product->en_name) }}" class="form-control" placeholder="English Name" />
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input name="name_ar" value="{{ old('name_ar',$product->ar_name) }}" class="form-control" placeholder="Arabic Name" />
        </div>
    </div>
    <div class="col-md-12">
        <div class="mb-3">
    ...
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <select class="form-control" name="dealer_id">
                ...
                <option {{ ($item-> id == $product->dealer_id ? 'selected': '' ) }} value="{{ $item->id }}">{{ $item->trans_name }}</option>
                @endforeach
            </select>
